...
- **Prerender для ботов:** характеристики, применимость, «Доставка и оплата», «Гарантия и возврат» (без шаблонного «О запчасти» и FAQ).
- **JSON-LD:** Product + BreadcrumbList + WebPage.
