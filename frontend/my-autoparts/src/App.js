...
const RepairOrderPaymentReceiptPrintPage = lazy(() => import('./pages/Autoservice/RepairOrderPaymentReceiptPrintPage'));
...
const AutoserviceMyPayrollPage = lazy(() => import('./pages/Autoservice/AutoserviceMyPayrollPage'));
...
function AutoserviceStaffRoute({ section, settingsOnly = false }) {
  ...
  if (section === 'order-receipt-print') {
    return (
      <LazyRoute>
        <RepairOrderPaymentReceiptPrintPage />
      </LazyRoute>
    );
  }
    ...
    <ErrorBoundary onError={captureBoundaryError}>
      ...
      <Routes>
        ...
        >
          ...
          />
          <Route
            path="/autoservice/orders/:orderId/print/receipt"
            element={<AutoserviceStaffRoute section="order-receipt-print" />}
          />
          <Route
            path="/autoservice/orders/:orderId/print"
            element={<AutoserviceStaffRoute section="order-print" />}
          />
          <Route
          ...
          />
          <Route
            path="/autoservice/payroll"
            element={<AutoserviceStaffRoute section="payroll" />}
          />
          <Route
            path="/autoservice/reports"
            element={<AutoserviceStaffRoute section="reports" />}
          />
          <Route
