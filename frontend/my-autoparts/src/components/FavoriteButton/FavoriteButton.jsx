...
export default function FavoriteButton({
  ...
  const isFavorite = useSelector(
    (state) => Boolean(state.userEngagement?.favoriteByProductId?.[productId]),
  );
  ...
  }, [dispatch, user, productId, isFavorite, navigate, location.pathname]);
  ...
  return (
    ...
    >
      <HeartIcon filled={isFavorite} className={size === 'sm' ? 'h-4 w-4' : 'h-5 w-5'} />
