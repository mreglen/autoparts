...
export default function AutoservicePayerRequisitesFields({
  form,
  onChange,
  disabled = false,
  idPrefix = 'payer-req',
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className={personType === 'legal' ? 'sm:col-span-2' : ''}>
          ...
          <Input
            ...
            placeholder={PAYER_PLACEHOLDERS.name}
            disabled={disabled}
            maxLength={255}
          />
        </div>
        <div className="sm:col-span-2">
          ...
          <Input
            ...
            placeholder={PAYER_PLACEHOLDERS.email}
            disabled={disabled}
            maxLength={255}
          />
        </div>
      ...
      {personType === 'legal' ? (
        <div>
          ...
          <Input
            ...
            placeholder={PAYER_PLACEHOLDERS.legal_name}
            disabled={disabled}
            maxLength={255}
          />
        </div>
      ...
      {personType === 'ie' ? (
        <div>
          ...
          <Input
            ...
            value={form?.legal_name || ''}
            onChange={(e) => setField('legal_name', e.target.value)}
            placeholder={PAYER_PLACEHOLDERS.legal_name_ie}
            disabled={disabled}
            maxLength={255}
          />
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder={PAYER_PLACEHOLDERS.address}
          disabled={disabled}
        />
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <Input
            ...
            placeholder={PAYER_PLACEHOLDERS.inn}
            disabled={disabled}
          />
        </div>
        {personType === 'legal' ? (
          <div>
            ...
            <Input
              ...
              placeholder={PAYER_PLACEHOLDERS.kpp}
              disabled={disabled}
            />
          </div>
        ) : null}
        {personType === 'legal' ? (
          <div>
            ...
            <Input
              ...
              placeholder={PAYER_PLACEHOLDERS.ogrn}
              disabled={disabled}
            />
          </div>
        ) : null}
        {personType === 'ie' ? (
          <div>
            ...
            <Input
              ...
              placeholder={PAYER_PLACEHOLDERS.ogrnip}
              disabled={disabled}
            />
          </div>
        ) : null}
