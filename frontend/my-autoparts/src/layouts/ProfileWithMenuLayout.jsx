...
export default function ProfileWithMenuLayout() {
    ...
    return (
        <div className={`min-h-screen bg-gray-50 ${!isSpecificChatPage && !isChatPage ? 'pb-24 md:pb-0' : 'pb-0'}`}>
            ...
            <main
                className={`mx-auto ${isSpecificChatPage ? 'max-w-full p-0 md:max-w-7xl md:px-0 md:sm:px-1 md:lg:px-2 md:py-6 md:sm:py-8' : 'max-w-7xl px-3 sm:px-1 lg:px-2 py-6 sm:py-8'} ${isChatPage ? 'max-md:p-0 max-md:py-0' : ''}`}
            >
                {isSpecificChatPage ? (
