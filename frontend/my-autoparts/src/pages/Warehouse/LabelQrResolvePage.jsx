...
export default function LabelQrResolvePage() {
  ...
  if (error) {
    return (
      <div className="mx-auto max-w-lg px-4 py-10 text-center max-lg:px-0 max-lg:pb-[var(--sg-mobile-bottom-nav-total,4.5rem)]">
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-10 text-center text-sm text-gray-600 max-lg:px-0">
      Открываем карточку…
    </div>
  );
}
