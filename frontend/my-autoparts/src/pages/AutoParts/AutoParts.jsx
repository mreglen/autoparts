...
function AutoParts() {
  ...
  if (status === 'failed' && activeTab === 'rossko') {
    return (
      <div className="mt-5 text-center py-10">
        <p className="text-lg text-red-600">Ошибка загрузки данных</p>
    ...
    <div className="mt-5">
      ...
      <div className="flex gap-4 mb-6">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'rossko'
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'my'
              ? 'bg-indigo-500 text-white'
              : 'bg-gray-200 text-gray-700'
            }`}
        >
              ...
              <table className="min-w-full divide-y divide-gray-200 table-fixed">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    {/* <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Склад</th> */}
