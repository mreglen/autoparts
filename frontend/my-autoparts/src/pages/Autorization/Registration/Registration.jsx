            ...
            {isBuyer === null ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <button
                            type="button"
                            onClick={() => handleFieldChange('showPassword', !formData.showPassword)}
                            className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700"
                            aria-label={formData.showPassword ? "Скрыть пароль" : "Показать пароль"}
                        >
                    ...
                    <div className="relative">
                        <input
                            type={formData.showPasswordRepeat ? 'text' : 'password'}
                        ...
                        <button
                            type="button"
                            onClick={() => handleFieldChange('showPasswordRepeat', !formData.showPasswordRepeat)}
                            className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700"
                            aria-label={formData.showPasswordRepeat ? "Скрыть пароль" : "Показать пароль"}
                        >
                            {formData.showPasswordRepeat ? (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.234a1.5 1.5 0 012.108-.658l2.453 1.226a1.5 1.5 0 001.548 0l2.453-1.226a1.5 1.5 0 012.108.658 8.25 8.25 0 010 4.532 1.5 1.5 0 01-2.108.658l-2.453-1.226a1.5 1.5 0 00-1.548 0l-2.453 1.226a1.5 1.5 0 01-2.108-.658 8.25 8.25 0 010-4.532z" />
                                </svg>
                            ) : (
