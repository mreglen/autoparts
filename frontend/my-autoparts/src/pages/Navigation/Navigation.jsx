        ...
        <div className="flex h-[4.25rem] min-w-0 w-full items-center gap-4 lg:gap-5">
          ...
          <div className="ml-auto flex shrink-0 items-center gap-1.5">
            <Link
              to="/cart"
              aria-label="Корзина"
              className="relative hidden h-10 items-center gap-2 rounded-sg bg-surface-muted px-3 text-sm text-ink-muted transition hover:bg-brand-50/50 hover:text-brand-600 sm:flex"
            >
