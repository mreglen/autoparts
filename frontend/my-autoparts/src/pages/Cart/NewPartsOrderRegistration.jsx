...
export default function NewPartsOrderRegistration() {
  ...
  if (placedOrder) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 max-lg:px-0">
  ...
  return (
    <div className={`mx-auto w-full max-w-2xl px-4 py-6 max-lg:px-0 sm:py-8 md:pb-8 ${MOBILE_PRODUCT_STICKY_SCROLL_PAD}`}>
      <Link
        to="/cart"
