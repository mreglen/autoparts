...
export default function NewPartsPaymentPage() {
    ...
    if (loading && !session) {
        return (
            <div className={`mx-auto max-w-5xl px-4 py-6 max-lg:px-0 md:py-10 ${MOBILE_PRODUCT_STICKY_SCROLL_PAD}`}>
    ...
    return (
        <div className={`mx-auto max-w-5xl px-4 py-6 max-lg:px-0 md:py-10 ${showStickyPay ? MOBILE_PRODUCT_STICKY_SCROLL_PAD : ''}`}>
            <div className="mb-6">
