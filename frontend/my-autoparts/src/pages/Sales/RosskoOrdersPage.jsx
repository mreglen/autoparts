...
export default function RosskoOrdersPage() {
  // Все хуки ДОЛЖНЫ быть в начале компонента, до любого условного возврата!
  ...
  // Проверка прав администратора - ТОЛЬКО после всех хуков!
  ...
  const getRosskoStatusColor = (statusCode) => {
    const colorMap = {
      ...
      31: 'bg-cyan-100 text-cyan-800',
      32: 'bg-amber-100 text-amber-800',
      33: 'bg-lime-100 text-lime-800',
      34: 'bg-red-200 text-red-900',
      35: 'bg-pink-100 text-pink-800',
      36: 'bg-emerald-100 text-emerald-800'
    };
  ...
  if (loading) {
    return (
      <div className="text-center py-16">
        ...
        <h2 className="text-2xl font-medium text-gray-900 mb-2">Загрузка заказов Росско...</h2>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Заказы Росско</h1>
