  ...
  if (loading) {
    return (
      <div className="text-center py-16 px-6">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-gray-900 mb-2">Загрузка покупок...</h2>
  ...
  if (error) {
    return (
      <div className="text-center py-16 px-6">
        ...
        <h2 className="text-xl md:text-2xl font-medium text-gray-900 mb-2">Ошибка загрузки покупок</h2>
      ...
      <div className="hidden md:block bg-white shadow-sm rounded-lg overflow-hidden">
        ...
        {orders.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Покупок нет</h3>
            <p className="mt-1 text-sm text-gray-500">Здесь будут отображаться ваши покупки</p>
          </div>
        )}
      </div>
      ...
      <div className="md:hidden space-y-5">
        ...
        {orders.length === 0 && (
          <div className="text-center py-16 px-6">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Покупок нет</h2>
            <p className="text-gray-600 text-base">Здесь будут отображаться ваши покупки</p>
          </div>
        )}
      </div>
    </div>
