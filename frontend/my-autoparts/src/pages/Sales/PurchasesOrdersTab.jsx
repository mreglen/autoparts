  ...
  if (loading) {
    return (
      <div className="text-center py-16">
        ...
        <h2 className="text-2xl font-medium text-gray-900 mb-2">Загрузка покупок...</h2>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="text-center py-16">
        ...
        <h2 className="text-2xl font-medium text-gray-900 mb-2">Ошибка загрузки покупок</h2>
