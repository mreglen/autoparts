...
function ProfileSkeleton() {
  return (
    <div className="mx-auto max-w-4xl animate-pulse px-4 py-10 max-lg:px-0 sm:px-6">
...
export default function PublicUserProfilePage() {
  ...
  if (error || !profile) {
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center max-lg:px-0">
        <Helmet>
  ...
  return (
    <div className="relative min-h-[70vh] pb-16">
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-8 max-lg:px-0 sm:px-6 lg:py-10">
        <Helmet>
