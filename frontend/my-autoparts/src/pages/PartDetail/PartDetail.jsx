      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              {(currentProduct.photos && currentProduct.photos.length > 0) || (currentProduct.videos && currentProduct.videos.length > 0) ? (
                <div>
                  {(() => {
                    ...
                    {(() => {
                      const totalCount = (currentProduct.photos?.length || 0) + (currentProduct.videos?.length || 0);
                      return totalCount > 1 && (
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-100">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">В наличии</span>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Склад</span>
                </div>
            ...
            {/* Add to Cart */}
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
              <h3 className="text-sm font-bold text-gray-900 mb-3">Добавить в корзину</h3>
              {(() => {
