...
export default function ProductPhotoReprocessSection() {
  ...
  if (loading) {
    return (
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <p className="text-sm text-gray-500">Загрузка статистики застрявших фото…</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <h2 className="mb-1 text-lg font-semibold text-gray-900">Повторная обработка фото</h2>
      <p className="mb-4 text-sm text-gray-500">
        Для фото, которые остались в{' '}
        <span className="font-mono text-gray-700">/temp/</span> или зависли со статусом
        pending/processing/failed: снова ставит задачу Celery (сжатие WebP, watermark, thumb) и
        переносит в{' '}
        <span className="font-mono text-gray-700">/uploads/pictures/</span>. Нужен живой worker
        Celery и файл на диске в temp.
      </p>
