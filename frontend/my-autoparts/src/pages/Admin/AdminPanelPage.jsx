...
import { fetchPublicSiteConfig, setShowNewAutoparts } from '../../redux/slices/PublicInfoSlice';

/**
 * Страница «Настройки» в разделе админа (только is_admin).
 */
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-gray-600 mb-6">
        Параметры публичного каталога и отображения сайта.
      </p>
