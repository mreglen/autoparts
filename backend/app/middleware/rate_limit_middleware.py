...
DEFAULT_RATE_LIMIT_RULES: tuple[RateLimitRule, ...] = (
    ...
    RateLimitRule(prefix="/api/public/laximo/filters/", max_requests=60, window_seconds=60),
    RateLimitRule(prefix="/api/public/laximo/wizard/", max_requests=60, window_seconds=60),
